...
Host.prototype.getSensors = function(callback) {
  this.sendCommand('sensors', function(err, data) {
...
Host.prototype.provision = function(hostname, rootpassword, profile, callback) {
  this.modem.methodCall('PXE_API.provisionHost', [{
    'mac': this.info.mac,
    'hostname': hostname,
